...
def play_game():
    ...
    while not is_game_over :
        ...
        if users_score == 0 or computers_score == 0 or users_score > 21:
            is_game_over = True
        #Hint 10: If the game has not ended, ask the user if they want to draw another card. If yes, then use the deal_card() func
        # tion to add another card to the user_cards List. If no, then the game has ended.
        else:
    ...
    print(f"    Your final hand: {user_cards} Current score: {users_score}")
    print(f"    computers final hand: {computer_cards} Current score: {computers_score}")
